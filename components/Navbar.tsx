    ...
    <>
      ...
      >
        <nav className="mx-auto flex w-full items-center justify-between px-6 md:px-16 lg:px-24 py-4 md:py-5">
          ...
          <a
            href="#"
            className="text-forest-ink text-[22px] md:text-[26px] font-semibold tracking-[-0.04em] hover:text-sage-dust transition-colors duration-300 flex items-center gap-2"
          >
          ...
          <a
            href="#contact"
            className="hidden md:inline-flex items-center gap-2 text-forest-ink text-[14px] font-medium bg-forest-ink/5 hover:bg-chartreuse-sprig/60 px-4 py-2 rounded-full transition-all duration-300"
          >
            Записаться
